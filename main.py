    ...
    def selectNext(self):
        ...
        while ( self.position < len(self.origin) ):
            ...
            if(aux == ' '):
                ...
                new_token = Token("AT", "AT")
                self.position += 1
                self.actual = new_token 
                return new_token
            
            elif(aux == "#"):
                new_token = Token("HASH", "HASH")
                self.position += 1
                self.actual = new_token 
                return new_token
            
            elif(aux == "$"):
                new_token = Token("DOLLAR", "DOLLAR")
                self.position += 1
                self.actual = new_token 
                return new_token
            
            elif(aux == "^"):
                new_token = Token("XOR", "XOR")
                self.position += 1
                self.actual = new_token 
                return new_token        
...
class Parser:
    ...
    def parseStatements():
        ...
        while(Parser.tokens.actual.type != "EOF"):
            if(Parser.tokens.actual.type == "XOR"):
                Parser.tokens.selectNext()
    ...
    def parseStatement():
        ...
        elif(Parser.tokens.actual.type == "DOLLAR"):
            Parser.tokens.selectNext()
        ...
        elif(Parser.tokens.actual.type == "HASH"):
            Parser.tokens.selectNext()
        ...
        elif(Parser.tokens.actual.type == "AT"):
            Parser.tokens.selectNext()
